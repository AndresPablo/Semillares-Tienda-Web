...
<html lang="es-AR">
    ...
    <body>
        ...
        <!-- Contenido -->
        <section id="trabajo" class="main">
            <div class="content my-5 p-5">
                <p>Hoy en día las personas esperan conseguir opciones veganas y nutritivas en cualquier local, nuestros mix son una buena opción para  cubrir esa necesidad de forma barata y sencilla.
                </br>
                    Queremos llegar a tu ciudad y para eso te ofrecemos <strong>dos modalidades de trabajo</strong> 
                </p>
                <br>
                <div class="row"> 
                    <div class="col-1 d-flex justify-content-end"><i class="bi bi-shop"> </i></div>    
                    <div class="col"><h3>Si tenés un local</h3>
                        <p>Si querés incorporar nuestros productos en tu stock realizas tu compra y la revendés al precio que te parezca conveniente. </p>
                    </div>
                </div>
                <div class="row"> 
                    <div class="col-1 d-flex justify-content-end"><i class="bi bi-truck"> </i></div>    
                    <div class="col"><h3>Si contás con un vehículo</h3>
                        <p>En el caso de que no tengas un local pero cuentes con movilidad propia, podés distibuir nuestros productos y armar tu propia 
                            cartera de clientes.
                            <br>Te dejamos nuestros productos con descuento para que puedas distribuirlo a un precio que no compita con el nuestro. 
                            <br>No te preocupes por la competencia, nos valemos de la <strong>confianza y la lealtad</strong> y vamos a respetar tu zona, hay espacio
                            para todas las personas que quieran ser parte de este proyecto.  </p>
                    </div>
                </div>
            </div>
            <div class="content-fluid bg-gris-claro">FOTOS DISTRIBUYENDO / FRACIONANDO EN EL LOCAL</div>
            <div class="content my-5 p-5">
                <h3>Listas de precios</h3>
                <p>Todos los productos con sus precios están en la sección tienda de nuestro menú y ahí mismo vas a poder comprar de manera sencilla.
                    <br>Te dejamos disponibles las listas en PDF para que puedas descargarlas en cualquier dispositivo: </p>
                <br>
                <br>
                <a class="enlace-simple" href="index.php">Lista para locales</a>
                <br>
                <a class="enlace-simple"  href="index.php">Lista para distribuidores</a>
            </div>
        </section>
